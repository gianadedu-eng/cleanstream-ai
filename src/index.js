            ...
            messages: [
              {
                ...
                content:
                  ...
                  title +
                  ". Return only JSON with decision GREEN, YELLOW or RED, a short reason, and confidence HIGH, MEDIUM or LOW. " +
                  "Do not claim to have researched or verified the programme. If uncertain, use YELLOW. " +
                  "HOLIDAY RULE: If the title is an individual episode substantially centred on a birthday or holiday celebration such as Christmas, Halloween, Easter, Thanksgiving or New Year, use RED. A brief mention is not enough. If the title is a series rather than an individual episode, do not use RED simply because the series may contain holiday or birthday episodes. " +
                  "WITCHCRAFT AND MAGIC RULE: If the programme or episode meaningfully contains witchcraft, wizardry, spells, sorcery, magic or similar supernatural practices, use RED. If you cannot determine this reliably, use YELLOW."
              }
            ]
          }
        );
